...
WebUI.setText(findTestObject('Page_Midtrans Mock Akulaku/input_Phone Number_phoneNumber'), '08133333333')
...
WebUI.verifyElementText(findTestObject('Page_Midtrans Mock Akulaku/div_Transaction is Pending'), 'Transaction is Pending')
