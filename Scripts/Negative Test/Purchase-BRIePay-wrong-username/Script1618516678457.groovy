...
WebUI.setText(findTestObject('Page_Midtrans Mock BRI/input_Nama_username'), 'testuser02')

WebUI.click(findTestObject('Page_Midtrans Mock BRI/button_Bayar'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Page_Midtrans Mock BRI/div_Transaksi Gagal'), 'Transaksi Gagal')
