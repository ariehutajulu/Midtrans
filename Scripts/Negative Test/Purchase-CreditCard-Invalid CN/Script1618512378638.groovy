...
WebUI.setText(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/CreditCard/input_cardnumber'), '4811 1111 1111 1113')
...
WebUI.verifyElementText(findTestObject('Page_Sample Store/div_Invalid card number'), 'Invalid card number')
