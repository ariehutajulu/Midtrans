...
WebUI.setText(findTestObject('Page_Midtrans Mock LineePay/input_Phone Number'), '1233218723')
...
WebUI.verifyElementText(findTestObject('Page_Midtrans Mock LineePay/div_The Phone Number or Pin is Incorrect. Please try again'), 
    'The Phone Number or Pin is Incorrect. Please try again.')
