...
WebUI.setText(findTestObject('Page_Midtrans Mock Payment Provider/input_Account ID'), 'testuser01')

WebUI.click(findTestObject('Page_Midtrans Mock Payment Provider/button_BayarOcto'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Page_Midtrans Mock OCTO Clicks/div_Transaksi Gagal'), 'Transaksi Gagal')
