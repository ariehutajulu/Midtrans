...
WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/a_Telkomsel'))

WebUI.setText(findTestObject('Page_Sample Store/input_TcashToken'), '12321')

WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/a_Pay Now'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Page_Sample Store/span_Incorrect token input'), 'Incorrect token input')
