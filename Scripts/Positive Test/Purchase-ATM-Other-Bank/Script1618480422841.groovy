...
WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/a_ATMBank'))

WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/ATMBank_transfer/a_ATM NetworkPay'))

WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/a_See Account Number'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/a_Please Complete Payment'))
