...
WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/a_BCA KlikPayPay'))
...
WebUI.click(findTestObject('Page_Midtrans Mock Payment Provider/button_Bayar'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Page_Midtrans Mock Payment Provider/div_Transaksi Sukses'), 'Transaksi Sukses')
