...
WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/a_e-Pay BRIPay'))

WebUI.click(findTestObject('Page_Sample Store/div_SEE INSTRUCTIONS'))

WebUI.delay(3)

WebUI.click(findTestObject('Page_Sample Store/close_BRI (1)'))

WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/a_Pay Now'))

WebUI.setText(findTestObject('Page_Midtrans Mock BRI/input_Nama_username'), 'testuser00')

WebUI.click(findTestObject('Page_Midtrans Mock BRI/button_Bayar'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Page_Midtrans Mock BRI/div_Transaksi Sukses'), 'Transaksi Sukses')
