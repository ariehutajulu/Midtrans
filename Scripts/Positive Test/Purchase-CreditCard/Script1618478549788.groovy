...
WebUI.setText(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/CreditCard/input_CVV'), '123')

WebUI.check(findTestObject('Page_Sample Store/PopUp_Pembayaran/checkbox_10persen'))

WebUI.check(findTestObject('Page_Sample Store/PopUp_Pembayaran/checkbox_10rp'))

WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/a_Pay Now'))

WebUI.setEncryptedText(findTestObject('Page_Sample Store/PopUp_Konfirmasi/input_Password_PaRes'), '4tAN/DuJV7Y=')

WebUI.click(findTestObject('Page_Sample Store/PopUp_Konfirmasi/button_OK'))

WebUI.click(findTestObject('Page_Sample Store/PopUp_Selesai/a_Done'))

WebUI.verifyElementText(findTestObject('Page_Sample Store/Homepage/div_Thank_you'), 'Thank you for your purchase.')
