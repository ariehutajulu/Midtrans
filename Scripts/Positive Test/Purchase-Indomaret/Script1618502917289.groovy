...
WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/a_Indomaret'))
...
WebUI.click(findTestObject('Page_Sample Store/div_See_Instructions_download'))
