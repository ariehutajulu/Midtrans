...
WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/a_LINE pay'))

WebUI.click(findTestObject('Page_Sample Store/div_SEE INSTRUCTIONS'))
...
WebUI.setText(findTestObject('Page_Midtrans Mock LineePay/input_Phone Number'), '0987654321')

WebUI.setEncryptedText(findTestObject('Page_Midtrans Mock LineePay/input_PIN'), 'iGDxf8hSRT4=')

WebUI.click(findTestObject('Page_Midtrans Mock LineePay/button_Proceed'))

WebUI.setEncryptedText(findTestObject('Page_Midtrans Mock LineePay/input_OTP'), '/eqXXKVOeTnOXsUty9Jq/Q==')

WebUI.click(findTestObject('Page_Midtrans Mock LineePay/button_Proceed'))

WebUI.verifyElementText(findTestObject('Page_Midtrans Mock LineePay/div_Transaction Success'), 'Transaction Success')
