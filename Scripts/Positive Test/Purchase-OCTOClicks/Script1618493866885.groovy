...
WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/Pilihan Pembayaran/a_OCTO_Clicks'))

WebUI.click(findTestObject('Page_Sample Store/div_SEE INSTRUCTIONSBca'))

WebUI.delay(3)

WebUI.click(findTestObject('Page_Sample Store/a_close_bcaklikpay'))

WebUI.click(findTestObject('Page_Sample Store/PopUp_Pembayaran/a_Pay Now'))

WebUI.setText(findTestObject('Page_Midtrans Mock Payment Provider/input_Account ID'), 'testuser00')

WebUI.click(findTestObject('Page_Midtrans Mock Payment Provider/button_BayarOcto'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Page_Midtrans Mock Payment Provider/div_Transaksi Sukses2'), 'Transaksi Sukses')
